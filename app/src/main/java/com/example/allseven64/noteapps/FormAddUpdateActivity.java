package com.example.allseven64.noteapps;
...
import com.example.allseven64.noteapps.db.NoteHelper;
...
public class FormAddUpdateActivity extends AppCompatActivity implements View.OnClickListener {
    EditText editTitle, edtDescription;
    Button btnSubmit;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_submit){
            ...
            /*jika fieldnya masih ksong maka tampilkan error*/
            ...
            if (!isEmpty){
                ...
                /*jika merupakan edit setresultnya UPDATE, jika bukan maka setresultnya ADD */
                if (isEdit){
